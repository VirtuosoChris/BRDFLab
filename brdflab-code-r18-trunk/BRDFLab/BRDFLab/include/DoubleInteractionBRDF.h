...
#ifndef DoubleInteractionBRDF_H
#define DoubleInteractionBRDF_H
...
#include "scatmech/sphprt.h"



class DoubleInteractionBRDF : public ScatmechBRDF
{

public:
	DoubleInteractionBRDF();
